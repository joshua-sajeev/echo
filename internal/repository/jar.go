...
type JarRepository interface {
	...
	ListWithSpend(ctx context.Context) ([]models.Jar, map[int64]float64, error)
	Update(ctx context.Context, id int64, name string, value float64) error
	Create(ctx context.Context, name string, value float64, sortOrder int) (int64, error)
